...
export default class ButtonEffect extends ButtonSimple {
    ...
    onLoad() {
        ...
        var ac_start = resLoader.get("common/anim/button_scale_start", AnimationClip)! as AnimationClip;
        var ac_end = resLoader.get("common/anim/button_scale_end", AnimationClip)! as AnimationClip;
